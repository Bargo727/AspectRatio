...
%the following code initializes the lattice to have a random initial
%condition
for i = 1:N
    for j = 1:M
        A(j,i) = 1;
...
figure(2)
errorbar(flip(P1),Q,V,'b-o','LineWidth',3,'MarkerFaceColor','b','MarkerSize',10)
xlabel('1 - p_{rot}')
ylabel('q')
set(gca,'fontsize',20)
